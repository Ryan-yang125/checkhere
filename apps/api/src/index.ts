...
function exampleReport(base: string, method: string): Response {
  ...
  const body = [
    '<header class="site-nav"><a class="brand-link" href="/"><span class="brand-mark">查</span><strong>CheckHere</strong></a>' + mainNav() + '</header>',
    '<main class="doc-wrap">',
    '<section class="report-hero"><div><div class="eyebrow">FIXED LOCAL REPORT EXAMPLE</div><h1>checkhere.page 自检</h1><p>生成于 CheckHere v0.4.0 · 4 个页面 · 桌面与移动端</p></div><div class="score" aria-label="得分 100">100</div></section>',
    '<div class="report-grid">',
    '<article class="report-card"><span class="severity ready">READY</span><strong>发布门禁通过</strong><p>4 个页面均成功加载，critical、fix_soon 和 polish 问题均为 0。</p><code>result=ready</code></article>',
...
function exampleMarkdown(method: string): Response {
  const body = [
    ...
    '## Issues',
    '',
    'critical 0 / fix_soon 0 / polish 0',
    '',
    '## Coverage',
    '',
    '- /',
...
function exampleJson(method: string): Response {
  const payload = {
    ...
    result: 'ready',
    score: 100,
    summary: '4 pages checked; no launch issues found.',
